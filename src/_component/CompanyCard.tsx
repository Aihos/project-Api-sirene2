      ...
      >
        ...
        <span className="text-sm">
          Nom et prénom : {[
            ...
            company.prenom2UniteLegale,
            company.prenom3UniteLegale,
            company.prenom4UniteLegale,
            company.prenomUsuelUniteLegale
          ].find(p => p) || ''} {company.nomUniteLegale || company.pseudonymeUniteLegale || ''}
        </span>
      </a>
